...
<div class="row">
    ...
    <ul class="col-md-10 col-sm-9 feed">
        ...
        <li>
            <h2 class="col-sm-12"><a href="?r=canvas/view&id=<?= $activity->canvas ?> "><?= $activity->action_type ?></a></h2>						<span class="pull-right"><time><?= $activity->created_on ?></time></span>
...
<div class="row">
    ...
    <ul class="col-md-10 col-sm-9 feed">
        ...
        <li>
            <h2 class="col-sm-12"><a href="?r=canvas/view&id=<?= $project->getProject()->id ?> "><?= $project->getProject()->title ?></a></h2>						<span class="pull-right"><time><?= $project->getProject()->date_added ?></time></span>
            <div class="col-sm-12 clearfix">
...
<div class="row">
    ...
    <ul class="col-md-10 col-sm-9 feed">
        ...
        <li>
            <h2 class="col-sm-12"><a href="?r=canvas/view&id=<?= $invitation->getProject()->id ?> "><?= $invitation->getProject()->title ?></a></h2>						<span class="pull-right"><time><?= $invitation->getProject()->date_added ?></time></span>
            <div class="col-sm-12 clearfix">
    ...
    <ul class="col-md-10 col-sm-9 feed">
        ...
        <li>
            <h2 class="col-sm-12"><a href="?r=canvas/view&id=<?= $project->id ?> "><?= $project->title ?></a></h2>						<span class="pull-right"><time><?= $project->date_added ?></time></span>
            <div class="col-sm-12 clearfix">
